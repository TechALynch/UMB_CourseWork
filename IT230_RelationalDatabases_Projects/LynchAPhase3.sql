...
INSERT PROFESSOR (PROFID, PROFSPECIALTY, PROFRANK, PROFLNAME, PROFFNAME, PROFINITIAL, PROFEMAIL )
...
INSERT DEPARTMENT (DEPTID, DEPTNAME)
VALUES ('MSIS', 'MSIS'),
('BIO', 'Biology'),
('PHY', 'Physics'),
('MKT', 'Marketing'),
...
INSERT STUDENT (STUDENTID, STUDENTLNAME, STUDENTFNAME, STUDENTINITIAL, STUDENTEMAIL)
...
INSERT COURSE (COURSEID, COURSETITLE, COURSEDESCRIPTION, COURSECREDITS )
...
INSERT CLASS (CLASSID, CLASSSECTION, CLASSDAYS, CLASSTIME, COURSEID, PROFID)
...
INSERT ENROLL (CLASSID, STUDENTID, ENROLL_DATE, GRADE, COURSEID)
...
INSERT DEPTCHAIR (DEPTID, PROFESSORID)
VALUES ('MSIS', 'SJ001'),
('PHY', 'JS001'),
('MKT', 'NS001'),
('CHE', 'MY001'),
...
INSERT ADVISOR (STUDENTID, PROFESSORID)
VALUES ('PP001', 'NS001'),
('AA001', 'CN001'),
('WS001', 'TA001'),
('MB001', 'JW001'),
...
INSERT STUDENTDEPT (STUDENTID, DEPTID)
VALUES ('PP001', 'MSIS'),
('AA001', 'BIO'),
('WS001', 'ECO'),
('AB001', 'CS'),
...
INSERT COURSEDEPT (COURSEID, DEPTID)
VALUES ('MGT105', 'MSIS'),
('MGT475', 'MKT'),
('ENG210', 'AER'),
('ENG320', 'CE'),
